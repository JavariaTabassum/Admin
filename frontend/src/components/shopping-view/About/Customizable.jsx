...
function Customizable(props) {
  return (
    <>
      <div className="lg:w-[48%] px-4">
        <div className="w-full relative">
          <h2 className='absolute md:top-64 lg:-left-72 md:-left-60 sm:-left-24 -left-36 top-36 rotate-[-90deg] px-3  whitespace-nowrap font-Roboto font-normal md:text-3xl text-base uppercase'>Explore new and popular styles</h2>
          <img className="md:w-auto w-[315px] md:h-[558px] h-[315px] lg:ml-4 sm:ml-20 ml-8" src={props.image} alt="Custom Dress" />
        </div>
      </div>
      <div className="lg:w-[45%] w-full lg:px-0 px-6 py-2 self-center">
        <h2 className="flex items-center md:text-[28px] text-lg font-normal font-satoshi gap-3 pb-4">
          <div className="p-3 bg-[#FF5555] rounded-full">
            <svg
        ...
        <p className="md:text-xl text-[13px] text-[#000000] opacity-[0.6] capitalize font-satoshi font-normal">
          ...
          suspendisse aliquam.Arcu at dictum sapien, mollis. Vulputate sit id
          accumsan, ultricies. In ultrices malesuada elit mauris etiam odio.
          Duis tristique lacus, et blandit viverra nisl velit. Sed mattis
          rhoncus, diam suspendisse sit nunc, gravida eu. Lectus eget eget ac

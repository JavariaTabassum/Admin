...
function OrderSummary() {
  return (
    <>
     ...
     <div className='flex font-satoshi text-base md:text-xl justify-between items-centerpy-2 '><h3 className='text-[#00000099] font-normal'>Discount(-20%)</h3><h3 className='font-bold text-right'>-$113</h3></div>
     ...
     <div className='flex justify-between items-center gap-3 w-full my-4'><div className='w-3/4 flex gap-2 items-center  bg-[#F0F0F0] px-4 py-3 rounded-full'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
</svg><input className='text-[#00000066] md:text-base text-sm font-satoshi font-normal focus:outline-none bg-[#F0F0F0]' type="text" placeholder='Add promo code' /></div><div className='w-1/4 text-base text-center font-satoshi font-medium text-[#ffffff] md:px-8 px-6 md:py-3 py-2 bg-[#000000] rounded-full flex justify-center items-center'>Apply</div></div>

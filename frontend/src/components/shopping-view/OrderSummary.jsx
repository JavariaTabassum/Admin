...
</svg><input className='text-[#00000066] md:text-base text-sm font-satoshi font-normal focus:outline-none bg-[#F0F0F0]' type="text" placeholder='Add promo code' /></div><div className='text-base font-satoshi font-medium text-[#ffffff] md:px-8 px-6 md:py-3 py-2 bg-[#000000] rounded-full'>Apply</div></div>

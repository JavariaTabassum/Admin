...
function GetInTouch() {
  return (
    ...
    <div className='lg:w-1/2 w-full flex flex-col lg:gap-6 gap-4 text-[#181818] font-Poppins px-4 pt-6'>
        <div>
        <h3 className='text-[#000D5199] font-normal uppercase md:text-base text-sm font-Albert'>intimatefashion</h3>
        ...
        <div className='lg:w-1/2 w-full bg-[#181818] rounded text-[#ffffff] md:text-xl text-lg  font-semibold py-3 px-4 text-center font-Albert'>Send message</div>
    </div>
    </>

...
//   const menuItems = [
//     { path: '/dashboard', name: 'Dashboard', icon: <img src={Home} alt="" className="w-5 h-5" /> },
//     { path: '/sales', name: 'Sales', icon: <img src={Pages} alt="" className="w-5 h-5" />  },
//     {
//       name: 'Product',
//       icon: <img src={Product} alt="" className="w-5 h-5" />,
//       dropdown: true,
//       subItems: [
...
//       ],
//     },
//     { path: '/shipping', name: 'Shipping', icon:<img src={Bell} alt="" className="w-5 h-5" /> },
//     { path: '/order', name: 'Order', icon:<img src={Calender} alt="" className="w-5 h-5" /> },
//     { path: '/message', name: 'Message', icon:<img src={message} alt="" className="w-5 h-5" /> },
//     { path: '/profile', name: 'Profile', icon: <img src={Profilelogo} alt="" className="w-5 h-5" /> },
//   ];

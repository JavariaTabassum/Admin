  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100 px-4 md:px-8">
      <div className="flex flex-col md:flex-row w-full max-w-lg md:max-w-5xl h-[600px] md:h-[550px] bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-6 md:p-10 relative">
          <div className="w-full max-w-sm">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-6">
                <label htmlFor="email" className="block text-sm font-medium text-gray-500 font-ibm-plex mb-2">
                  Email
                </label>
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-[40px] bg-slate-100 focus:ring focus:ring-pink-300 focus:outline-none ${
              ...
              <div className="mb-6">
                <label htmlFor="password" className="block text-sm font-medium font-ibm-plex text-gray-500 mb-2">
                  Password
                </label>
                <div className="relative">
                  <input
              ...
              <button
                type="submit"
                className="w-full py-3 bg-pink-500 text-white mt-8 font-medium rounded-[40px] hover:bg-pink-600 font-ibm-plex transition"
              >
                Log in
              </button>
            </form>
        ...
        {/* Right Section */}
        <div className="hidden md:flex w-full md:w-1/2 bg-pink-500 items-end relative overflow-hidden">
